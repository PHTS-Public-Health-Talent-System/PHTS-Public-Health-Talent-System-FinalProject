...
import workforceComplianceRoutes from '@/modules/workforce-compliance/routes/workforce-compliance.routes.js';
...
app.use('/api/workforce-compliance', workforceComplianceRoutes);
// Backward-compatible alias for existing clients.
app.use('/api/alerts', workforceComplianceRoutes);
