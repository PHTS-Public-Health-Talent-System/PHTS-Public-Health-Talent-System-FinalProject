    ...
    <div className="p-8 space-y-8 pb-20">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
        ...
        <StatCard
          ...
          href="/head-finance/requests?status=approved"
        />
        <StatCard
          title="เกินกำหนดเวลา"
          ...
          <Card className="border-border shadow-sm h-full flex flex-col">
            <CardHeader className="flex flex-row items-center justify-between pb-2 border-b">
              ...
              <Button variant="ghost" size="sm" asChild className="text-xs">
                <Link href="/head-finance/requests">ดูทั้งหมด</Link>
              </Button>
            </CardHeader>
              ...
              <div className="divide-y divide-border/50">
                {pendingPayrolls.length > 0 ? (
                  pendingPayrolls.map((payroll) => (
                    <Link
                      key={payroll.id}
                      href={`/head-finance/payroll/${payroll.id}`}
              ...
              {pendingPayrolls.length > 0 && (
                <div className="p-2 bg-muted/10 border-t">
                  <Button variant="ghost" size="sm" className="w-full text-xs h-8" asChild>
                    <Link href="/head-finance/payroll">จัดการรอบจ่ายทั้งหมด</Link>
                  </Button>
                </div>
              )}
            </CardContent>
