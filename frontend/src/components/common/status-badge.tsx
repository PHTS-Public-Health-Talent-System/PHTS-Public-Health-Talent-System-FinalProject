...
const STATUS_STYLES: Record<RequestStatus, string> = {
  ...
  PENDING_HR: "bg-sky-100 text-sky-700 hover:bg-sky-200",
  PENDING_FINANCE: "bg-cyan-100 text-cyan-700 hover:bg-cyan-200",
...
export function StatusBadge({
  ...
  return (
    <Badge variant="outline" className={cn(getStatusStyle(status, currentStep ?? undefined), className)}>
